 ...
 * Can be used to start/stop seleniumWindows server, chromedriver, phantomjs, mailcatcher, etc.
 *
 ...
 *             - java -jar ~/seleniumWindows-server.jar
 * ```
 *
 ...
 *     enabled:
 *         - Codeception\Extension\RunProcess:
 *             0: java -jar ~/seleniumWindows-server.jar
 *             1: mailcatcher
